...
public class CommandLineParser {
    ...
    private ArrayList<String> mergeQuotes(final ArrayList<String> wordsSplitOnQuotes) {
        ...
        int loopWordIndex;
        for (var wordIndex = 0; wordIndex < wordsSplitOnQuotes.size(); wordIndex = loopWordIndex) {
    ...
    private ArrayList<String> mergeEquals(final ArrayList<String> wordsSplitOnEquals) {
        ...
        int loopWordIndex;
        for (var wordIndex = 0; wordIndex < wordsSplitOnEquals.size(); wordIndex = loopWordIndex) {
