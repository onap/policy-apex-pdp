...
public class CliUtilsTest {
    ...
    public void testCreateToscaServiceTemplate() throws IOException, CoderException {
        ...
        assertEquals(outputTosca, outputToscaCompare);
    }
    ...
    public void testValidateReadableFile_invalidfile() {
        ...
        try {
            CliUtils.validateReadableFile("Apex Config File", invalidFileName);
        } catch (Exception e) {
            assertTrue(e.getMessage().equals("File " + invalidFileName + " of type Apex Config File does not exist"));
        }
    }
    ...
    public void testValidateWritableFile_invalidfile() {
        ...
        try {
            CliUtils.validateWritableFile("Output Tosca Policy File", invalidFileName);
        } catch (Exception e) {
            assertTrue(e.getMessage().equals("File " + invalidFileName
                + " of type Output Tosca Policy File is not a normal file"));
        }
    }
    ...
    public void testValidateWritableDirectory_invaliddirectory() {
        try {
            CliUtils.validateWritableDirectory("Working Directory", CommonTestData.APEX_CONFIG_FILE_NAME);
        } catch (Exception e) {
            assertTrue(e.getMessage().equals("directory " + CommonTestData.APEX_CONFIG_FILE_NAME
    ...
    public void testGenerateArgumentsForCliEditor_success() {
        ...
        List<String> cliArgsList = CliUtils.generateArgumentsForCliEditor(params, optionVariableMap,
            ApexCliToscaParameters.class);
