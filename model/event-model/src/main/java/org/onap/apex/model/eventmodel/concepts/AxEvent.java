 ...
 * example a 4G cell power event might have the name space {@code com.ericsson.radio.4g} and the name
 * {@code PowerEvent}. The source and target of the event are reserved to hold an identifier that defines the sender and
 * receiver of an event respectively. The definition and structure of these fields is reserved for future use and their
 * use by applications is currently not recommended.
 * <p>
