...
public final class PolicyModelSplitter {
     ...
     */
    public static AxPolicyModel getSubPolicyModel(final AxPolicyModel sourcePolicyModel,
                    final Collection<AxArtifactKey> subPolicies, final boolean ignoreInvalidSource)
        ...
        newPolicyModel.getKeyInformation().getKeyInfoMap().put(sourcePolicyModel.getPolicies().getKey(),
                        sourcePolicyModel.getKeyInformation().getKeyInfoMap()
                                        .get(sourcePolicyModel.getPolicies().getKey()));
        ...
        newPolicyModel.getKeyInformation().getKeyInfoMap().put(sourcePolicyModel.getSchemas().getKey(),
                        sourcePolicyModel.getKeyInformation().getKeyInfoMap()
                                        .get(sourcePolicyModel.getSchemas().getKey()));
        ...
        newPolicyModel.getKeyInformation().getKeyInfoMap().put(sourcePolicyModel.getEvents().getKey(), sourcePolicyModel
                        .getKeyInformation().getKeyInfoMap().get(sourcePolicyModel.getEvents().getKey()));
        ...
        newPolicyModel.getKeyInformation().getKeyInfoMap().put(sourcePolicyModel.getAlbums().getKey(), sourcePolicyModel
                        .getKeyInformation().getKeyInfoMap().get(sourcePolicyModel.getAlbums().getKey()));
        ...
        newPolicyModel.getKeyInformation().getKeyInfoMap().put(sourcePolicyModel.getTasks().getKey(), sourcePolicyModel
                        .getKeyInformation().getKeyInfoMap().get(sourcePolicyModel.getTasks().getKey()));
