...
public class AxStateParams {
    ...
    public static AxStateParamsBuilder builder() {
        return new AxStateParamsBuilder();
    }

    public static class AxStateParamsBuilder {
        AxStateParams axStateParams = new AxStateParams();
        ...
        public AxStateParamsBuilder stateOutputs(Map<String, AxStateOutput> stateOutputs) {
            axStateParams.stateOutputs = stateOutputs;
            return this;
        }
        ...
        public AxStateParamsBuilder contextAlbumReferenceSet(Set<AxArtifactKey> contextAlbumReferenceSet) {
            axStateParams.contextAlbumReferenceSet = contextAlbumReferenceSet;
            return this;
        }
        ...
        public AxStateParamsBuilder taskSelectionLogic(AxTaskSelectionLogic taskSelectionLogic) {
            axStateParams.taskSelectionLogic = taskSelectionLogic;
            return this;
        }
        ...
        public AxStateParamsBuilder stateFinalizerLogicMap(
            ...
            axStateParams.stateFinalizerLogicMap = stateFinalizerLogicMap;
            return this;
        }
        ...
        public AxStateParamsBuilder defaultTask(AxArtifactKey defaultTask) {
            axStateParams.defaultTask = defaultTask;
            return this;
        }
        ...
        public AxStateParamsBuilder taskReferenceMap(Map<AxArtifactKey, AxStateTaskReference> taskReferenceMap) {
            axStateParams.taskReferenceMap = taskReferenceMap;
            return this;
        }

        public AxStateParams build() {
            return axStateParams;
        }
    }
}
