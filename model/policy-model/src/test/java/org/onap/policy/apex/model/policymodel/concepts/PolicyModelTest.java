...
public class PolicyModelTest {
    ...
    public void testPolicyModel() {
        ...
        assertNotEquals((Object) "Hello", model);
        assertNotEquals(new AxPolicyModel(new AxArtifactKey()), model);
        assertNotEquals(new AxPolicyModel(AxArtifactKey.getNullKey(), new AxContextSchemas(schemasKey),
                        new AxKeyInformation(keyInfoKey), new AxEvents(eventsKey), new AxContextAlbums(albumsKey),
                        new AxTasks(tasksKey), new AxPolicies(policiesKey)), model);
        assertNotEquals(new AxPolicyModel(modelKey, new AxContextSchemas(), new AxKeyInformation(keyInfoKey),
                        new AxEvents(eventsKey), new AxContextAlbums(albumsKey), new AxTasks(tasksKey),
                        new AxPolicies(policiesKey)), model);
        assertNotEquals(new AxPolicyModel(modelKey, new AxContextSchemas(schemasKey), new AxKeyInformation(),
                        new AxEvents(eventsKey), new AxContextAlbums(albumsKey), new AxTasks(tasksKey),
                        new AxPolicies(policiesKey)), model);
        assertNotEquals(new AxPolicyModel(modelKey, new AxContextSchemas(schemasKey),
        ...
        assertNotEquals(new AxPolicyModel(modelKey, new AxContextSchemas(schemasKey),
                        new AxKeyInformation(keyInfoKey), new AxEvents(eventsKey), new AxContextAlbums(albumsKey),
                        new AxTasks(), new AxPolicies(policiesKey)), model);
        assertNotEquals(new AxPolicyModel(modelKey, new AxContextSchemas(schemasKey),
                        new AxKeyInformation(keyInfoKey), new AxEvents(eventsKey), new AxContextAlbums(albumsKey),
                        new AxTasks(tasksKey), new AxPolicies()), model);
        assertEquals(new AxPolicyModel(modelKey, new AxContextSchemas(schemasKey),
                        new AxKeyInformation(keyInfoKey), new AxEvents(eventsKey), new AxContextAlbums(albumsKey),
                        new AxTasks(tasksKey), new AxPolicies(policiesKey)), model);
