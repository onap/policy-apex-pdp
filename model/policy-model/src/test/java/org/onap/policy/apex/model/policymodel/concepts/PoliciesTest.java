...
public class PoliciesTest {
    ...
    public void testPolicies() {
        ...
        assertNotEquals(policy, (Object) "Hello");
        assertNotEquals(policy,
                        new AxPolicy(AxArtifactKey.getNullKey(), savedTemplate, savedStateMap, savedFirstState));
        assertNotEquals(policy, new AxPolicy(savedPolicyKey, "SomeTemplate", savedStateMap, savedFirstState));
        assertNotEquals(policy, new AxPolicy(savedPolicyKey, savedTemplate, stateMapEmpty, savedFirstState));
        assertNotEquals(policy, new AxPolicy(savedPolicyKey, savedTemplate, savedStateMap, "SomeFirstState"));
        assertEquals(policy, new AxPolicy(savedPolicyKey, savedTemplate, savedStateMap, savedFirstState));
