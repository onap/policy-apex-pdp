...
public class TestState {
    ...
    public void testState() {
        ...
        assertNotNull(new AxState(
                AxStateParams.builder().key(new AxReferenceKey()).trigger(new AxArtifactKey())
        ...
        assertFalse(state.equals(
                new AxState(AxStateParams.builder().key(new AxReferenceKey()).trigger(triggerKey)
                        ...
                        .build())));
        assertFalse(state.equals(
                new AxState(AxStateParams.builder().key(stateKey).trigger(new AxArtifactKey())
                        .stateOutputs(soMap).contextAlbumReferenceSet(ctxtSet).taskSelectionLogic(tsl)
                        .stateFinalizerLogicMap(sflMap).defaultTask(defTaskKey).taskReferenceMap(trMap)
                        .build())));
        assertFalse(state.equals(
                new AxState(AxStateParams.builder().key(stateKey).trigger(triggerKey).stateOutputs
        ...
        assertFalse(state.equals(new AxState(
                AxStateParams.builder().key(stateKey).trigger(triggerKey).stateOutputs(soMap)
        ...
        assertFalse(state.equals(
                new AxState(AxStateParams.builder().key(stateKey).trigger(triggerKey).stateOutputs
                        ...
                        .build())));
        assertTrue(state.equals(new AxState(AxStateParams.builder().key(stateKey).trigger(triggerKey)
                .stateOutputs(soMap).contextAlbumReferenceSet(ctxtSet).taskSelectionLogic(tsl)
                .stateFinalizerLogicMap(sflMap).defaultTask(defTaskKey).taskReferenceMap(trMap)
                .build())));
        ...
        assertNotEquals(0, state.compareTo(
                new AxState(
                        AxStateParams.builder().key(stateKey).trigger(new AxArtifactKey()).stateOutputs(soMap)
                                .contextAlbumReferenceSet(ctxtSet).taskSelectionLogic(tsl)
                                .stateFinalizerLogicMap(sflMap).defaultTask(defTaskKey).taskReferenceMap(trMap)
                                .build())));
        assertNotEquals(0, state.compareTo(
                new AxState(AxStateParams.builder().key(stateKey).trigger(triggerKey).stateOutputs(soEmptyMap)
                        .contextAlbumReferenceSet(ctxtSet).taskSelectionLogic(tsl)
                        .stateFinalizerLogicMap(sflMap).defaultTask(defTaskKey).taskReferenceMap(trMap)
                        .build())));
        assertNotEquals(0, state.compareTo(
                new AxState(AxStateParams.builder().key(stateKey).trigger(triggerKey).stateOutputs(soMap)
