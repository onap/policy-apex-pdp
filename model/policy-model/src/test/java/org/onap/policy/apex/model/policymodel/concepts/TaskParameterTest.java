...
public class TaskParameterTest {
    ...
    public void testTaskParameter() {
        ...
        assertNotNull(par);
        assertNotEquals((Object) "Hello", par);
        assertNotEquals(new AxTaskParameter(AxReferenceKey.getNullKey(), "DefaultValue"), par);
        assertNotEquals(new AxTaskParameter(parKey, "OtherDefaultValue"), par);
        assertEquals(new AxTaskParameter(parKey, "DefaultValue"), par);
