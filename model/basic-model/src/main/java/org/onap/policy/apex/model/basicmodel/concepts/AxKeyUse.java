...
public class AxKeyUse extends AxKey {
     ...
     * (non-Javadoc)
     *
     * @see org.onap.policy.apex.model.basicmodel.concepts.AxKey#getCompatibility(com.
     ...
     * (non-Javadoc)
     *
     * @see org.onap.policy.apex.model.basicmodel.concepts.AxKey#isCompatible(com.
     * ericsson.apex.model.basicmodel.concepts.AxKey)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.onap.policy.apex.model.basicmodel.concepts.AxConcept#validate(com.
