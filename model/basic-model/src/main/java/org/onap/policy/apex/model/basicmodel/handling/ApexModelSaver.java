...
public class ApexModelSaver<M extends AxModel> {
    ...
    /**
     * Constructor, specifies the type of the Apex model (a sub class of {@link AxModel}), the model
     * to write, and the path of a directory to which to write the model.
     *
     ...
     * @param writePath the directory to which models will be written. The name of the written model
     *        will be the Model Name for its key with the suffix {@code .xml} or {@code .json}.
     */
    ...
    /**
     * Write an Apex model to a file in XML format. The model will be written to
     * {@code <writePath/modelKeyName.xml>}
     *
    ...
    /**
     * Write an Apex model to a file in JSON format. The model will be written to
     * {@code <writePath/modelKeyName.json>}
     *
     * @throws ApexException on errors writing the Apex model
     */
