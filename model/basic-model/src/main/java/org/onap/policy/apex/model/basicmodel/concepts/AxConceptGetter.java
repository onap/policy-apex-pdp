 ...
 *
 * <p>It forces those concepts with maps to implement the get methods specified on this interface as
 * convenience methods to avoid concept users having to use a second level of referencing to access
 * concepts in the the maps.
 *
