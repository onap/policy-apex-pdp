 ...
 * response.
 *
 * <p>The parameters for this plugin are: <ol> <li>url: The URL that the Apex Rest Requestor will connect to over REST
 * for REST request sending. This parameter is mandatory. <li>httpMethod: The HTTP method to use when making requests
 * over REST, legal values are GET (default), POST, PUT, and DELETE. <li>restRequestTimeout: The time in milliseconds to
 * wait for a REST request to complete. <li>restRequestHeader: The necessary header needed </ol>
 *
