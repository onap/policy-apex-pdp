...
public class ApexRestClientProducerTest {
    ...
    public void testApexRestClientProducerErrors() throws ApexEventException {
        ...
        assertThatThrownBy(() -> arcp.init("RestClientProducer", producerParameters))
            .hasMessageContaining("specified producer properties are not applicable to REST client producer"
                    + " (RestClientProducer)");
        ...
        }).hasMessageContaining("specified HTTP method of \"DELETE\" is invalid, only HTTP methods \"POST\""
