...
public class RestClientCarrierTechnologyParametersTest {
    ...
    public void testRestClientCarrierTechnologyParametersOk() {
        ...
        try {
            ...
            RestClientCarrierTechnologyParameters rrctp0 =
                    (RestClientCarrierTechnologyParameters) parameters.getEventInputParameters()
                                                                    .get("RestClientConsumer0")
                                                                    .getCarrierTechnologyParameters();
            assertEquals(0, rrctp0.getHttpHeaders().length);

            RestClientCarrierTechnologyParameters rrctp1 =
                    (RestClientCarrierTechnologyParameters) parameters.getEventInputParameters()
                                                                    .get("RestClientConsumer1")
                                                                    .getCarrierTechnologyParameters();
    ...
    public void testGettersAndSetters() {
        ...
        assertEquals("RestClientCarrierTechnologyParameters "
                             + "[url=http://some.where, httpMethod=DELETE, httpHeaders=[[aaa, bbb], [ccc, ddd]], httpCodeFilter=[1-5][0][0-5]]",
                rrctp.toString());
    }
}
