...
public class CommonTestData {
    ...
    protected static final String ARRAY_SCHEMA =
        "{\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"type\":\"array\",\"items\":"
            + "{\"type\":\"object\",\"required\":[\"test\"],\"properties\":{\"test\":{\"type\":\"integer\"}}}}";
    protected static final String ARRAY_DATA = "[\n  {\n    \"test\": 1\n  },\n  {\n    \"test\": 2\n  }\n]";
    ...
    public static void setUpBeforeClass() throws IOException {
        ...
        COMMONHEADER =
            TextFileUtils.getTextFileAsString("src/test/resources/data/commonHeader.json").replaceAll("\r", "");
        MEASUREMENTGROUPS_TYPE =
            TextFileUtils.getTextFileAsString("src/test/resources/schema/measurementGroupsType.json");
        MEASUREMENTGROUPS =
            TextFileUtils.getTextFileAsString("src/test/resources/data/measurementGroups.json").replaceAll("\r", "");
    }
