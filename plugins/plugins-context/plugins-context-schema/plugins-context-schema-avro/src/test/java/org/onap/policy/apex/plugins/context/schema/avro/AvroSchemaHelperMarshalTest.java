...
public class AvroSchemaHelperMarshalTest {
    ...
    public void testBooleanMarshal() {
        ...
        assertThatThrownBy(() -> schemaHelper1.marshal2String(0))
            .hasMessageContaining("AvroTest:0.0.1: object \"0\" Avro marshalling failed: "
        ...
        assertThatThrownBy(() -> schemaHelper1.marshal2String("0"))
            .hasMessageContaining("AvroTest:0.0.1: object \"0\" Avro marshalling failed: class java.lang.String "
    ...
    public void testIntMarshal() {
        ...
        assertThatThrownBy(() -> schemaHelper2.marshal2String("Hello"))
            .hasMessageContaining("AvroTest:0.0.1: object \"Hello\" Avro marshalling failed: "
                + "class java.lang.String cannot be cast to class java.lang.Number");
        assertThatThrownBy(() -> schemaHelper2.marshal2String(null))
            .hasMessageContaining("AvroTest:0.0.1: cannot encode a null object of class \"java.lang.Integer\"");
    }
    ...
    public void testLongMarshal() {
        ...
        assertThatThrownBy(() -> schemaHelper3.marshal2String(null))
            .hasMessageContaining("AvroTest:0.0.1: cannot encode a null object of class \"java.lang.Long\"");
    }
    ...
    public void testFloatMarshal() {
        ...
        assertThatThrownBy(() -> schemaHelper4.marshal2String(null))
            .hasMessageContaining("AvroTest:0.0.1: cannot encode a null object of class \"java.lang.Float\"");
    }
    ...
    public void testDoubleMarshal() {
        ...
        assertThatThrownBy(() -> schemaHelper5.marshal2String(null))
            .hasMessageContaining("AvroTest:0.0.1: cannot encode a null object of class \"java.lang.Double\"");
    }
    ...
    public void testStringMarshal() {
        ...
        assertThatThrownBy(() -> schemaHelper7.marshal2String(null))
            .hasMessageContaining("AvroTest:0.0.1: cannot encode a null object of class \"java.lang.String\"");
    }
    ...
    public void testBytesMarshal() {
        ...
        assertThatThrownBy(() -> schemaHelper.marshal2String(null))
            .hasMessageContaining("AvroTest:0.0.1: cannot encode a null object of class \"[Ljava.lang.Byte;\"");
    }
}
