...
public class AvroSchemaEnumTest {
    ...
    public void testEnumUnmarshalMarshal() throws IOException {
        ...
        assertThatThrownBy(() -> testUnmarshalMarshal(schemaHelper, "src/test/resources/data/EnumExampleBad0.json"))
            .hasMessageContaining("AvroTest:0.0.1: object \"\"TWEED\"\" Avro unmarshalling failed: Unknown symbol "
                    + "in enum TWEED");
        assertThatThrownBy(() -> testUnmarshalMarshal(schemaHelper, "src/test/resources/data/EnumExampleBad1.json"))
            .hasMessageContaining("AvroTest:0.0.1: object \"\"Hearts\"\" Avro unmarshalling failed: Unknown symbol "
                    + "in enum Hearts");
    }
