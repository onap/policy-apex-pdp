...
class HealthCheckSchemaTest {
    ...
    void testHealthCheck() throws IOException {
        ...
        testUnmarshalMarshal(schemaHelper);
        ...
        final GenericRecord actionIdentifiersRecord =
        ...
        inputRecord.put("action_DasH_identifiers", actionIdentifiersRecord);
        ...
        actionIdentifiersRecord.put("vnf_DasH_id", "49414df5-3482-4fd8-9952-c463dff2770b");
        ...
        assertEquals(eventString.replaceAll("\\s+", ""), outString.replaceAll("\\s+", ""));
    }
     ...
     * @throws IOException Signals that an I/O exception has occurred.
     */
    private void testUnmarshalMarshal(final SchemaHelper schemaHelper) throws IOException {
        final String inString = TextFileUtils.getTextFileAsString("src/test/resources/data/HealthCheckEvent.json");
