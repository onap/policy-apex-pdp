...
public class AvroSchemaRecordTest {
    ...
    public void testRecordCreateRecord() throws IOException {
        ...
        assertThatThrownBy(() -> {
            GenericRecord subRecordA = (GenericRecord) schemaHelper.createNewSubInstance("IDontExist");
        }).hasMessageContaining("AvroTest:0.0.1: the schema \"User\" does not have a subtype of type \"IDontExist\"");
    }
