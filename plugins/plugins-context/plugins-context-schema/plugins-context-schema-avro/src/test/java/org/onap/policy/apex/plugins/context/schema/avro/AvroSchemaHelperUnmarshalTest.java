...
public class AvroSchemaHelperUnmarshalTest {
    ...
    public void testNullUnmarshal() {
        ...
        assertThatThrownBy(() -> schemaHelper0.createNewInstance())
            .hasMessageContaining("AvroTest:0.0.1: could not create an instance, schema class for the schema is null");
        assertEquals(null, schemaHelper0.unmarshal("null"));

        assertThatThrownBy(() -> schemaHelper0.unmarshal("123"))
            .hasMessageContaining("AvroTest:0.0.1: object \"123\" Avro unmarshalling failed: "
    ...
    public void testBooleanUnmarshal() {
        ...
        assertThatThrownBy(() -> schemaHelper1.unmarshal(0))
            .hasMessageContaining("AvroTest:0.0.1: object \"0\" of type \"java.lang.Integer\" must be assignable to "
    ...
    public void testIntUnmarshal() {
        ...
        assertThatThrownBy(() -> schemaHelper2.createNewInstance())
            .hasMessageContaining("AvroTest:0.0.1: could not create an instance of class \"java.lang.Integer\" "
        ...
        assertThatThrownBy(() -> schemaHelper2.unmarshal("2147483648"))
            .hasMessageContaining("AvroTest:0.0.1: object \"2147483648\" Avro unmarshalling failed: "
                + "Numeric value (2147483648) out of range of int");
        assertThatThrownBy(() -> schemaHelper2.unmarshal("-2147483649"))
            .hasMessageContaining("AvroTest:0.0.1: object \"-2147483649\" Avro unmarshalling failed: "
                + "Numeric value (-2147483649) out of range of int");
        assertThatThrownBy(() -> schemaHelper2.unmarshal(null))
            .hasMessageContaining("AvroTest:0.0.1: object \"null\" Avro unmarshalling failed: "
    ...
    public void testLongUnmarshal() {
        ...
        assertThatThrownBy(() -> schemaHelper3.unmarshal("9223372036854775808"))
            .hasMessageContaining("AvroTest:0.0.1: object \"9223372036854775808\" Avro unmarshalling failed: "
                + "Numeric value (9223372036854775808) out of range of long");
        assertThatThrownBy(() -> schemaHelper3.unmarshal("-9223372036854775809"))
            .hasMessageContaining("AvroTest:0.0.1: object \"-9223372036854775809\" Avro unmarshalling failed: "
                + "Numeric value (-9223372036854775809) out of range of long");
        assertThatThrownBy(() -> schemaHelper3.unmarshal("\"Hello\""))
            .hasMessageContaining("AvroTest:0.0.1: object \"\"Hello\"\" Avro unmarshalling failed: "
    ...
    public void testFloatUnmarshal() {
        ...
        assertThatThrownBy(() -> schemaHelper4.createNewInstance())
            .hasMessageContaining("AvroTest:0.0.1: could not create an instance of class \"java.lang.Float\" "
    ...
    public void testDoubleUnmarshal() {
        ...
        assertThatThrownBy(() -> schemaHelper5.createNewInstance())
            .hasMessageContaining("AvroTest:0.0.1: could not create an instance of class \"java.lang.Double\" "
    ...
    public void testBytesUnmarshal() {
        ...
        assertThatThrownBy(() -> schemaHelper.createNewInstance())
            .hasMessageContaining("AvroTest:0.0.1: could not create an instance of class \"[Ljava.lang.Byte;\" "
