...
public class ApexPolicyStatisticsManager {
    ...
    public static final String REG_APEX_PDP_POLICY_COUNTER = "object:pdp/statitics/policy/counter";
    ...
    public static ApexPolicyStatisticsManager getInstanceFromRegistry() {
        ...
        try {
            ...
            LOGGER.debug("ApexPolicyStatisticsManager is not registry yet");
        }
        return instance;
    }
