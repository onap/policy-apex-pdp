...
public class CarrierTechnologyParametersJsonAdapter
    ...
    public CarrierTechnologyParameters deserialize(final JsonElement json, final Type typeOfT,
        ...
        if (carrierTechnologyLabel == null || carrierTechnologyLabel.length() == 0) {
            final String errorMessage = "carrier technology parameter \"" + CARRIER_TECHNOLOGY_TOKEN + VALUE_TAG
        ...
        if (carrierTechnologyParameterClassName == null || carrierTechnologyParameterClassName.length() == 0) {
            final String errorMessage = CARRIER_TECHNOLOGY_PREAMBLE + carrierTechnologyLabel + "\" parameter \""
                    + PARAMETER_CLASS_NAME + VALUE_TAG
        ...
        try {
            ...
            final String errorMessage =
                    CARRIER_TECHNOLOGY_PREAMBLE + carrierTechnologyLabel + "\" parameter \"" + PARAMETER_CLASS_NAME
                            + VALUE_TAG + carrierTechnologyParameterClassName + "\", could not find class";
