...
public class EventProducerFactoryTest {
    ...
    public void createConsumerNoTechnologyParameter() throws ApexEventException {
        final EventHandlerParameters parameters = new EventHandlerParameters();
        final String name = RandomStringUtils.randomAlphabetic(4);

        factory.createProducer(name, parameters);
    }

    @Test(expected = ApexEventException.class)
    public void createConsumerNoConsumerPlugin() throws ApexEventException {
        final EventHandlerParameters parameters = new EventHandlerParameters();
        final String name = RandomStringUtils.randomAlphabetic(4);
    ...
    @Test(expected = ApexEventException.class)
    public void createConsumerWrongProducerPluginName() throws ApexEventException {
        final EventHandlerParameters parameters = new EventHandlerParameters();
