...
public class SuperDooperExecutorParameters extends ExecutorParameters {
    ...
    public SuperDooperExecutorParameters() {
        this.setTaskExecutorPluginClass(
                "org.onap.policy.apex.services.onappf.parameters.dummyclasses.DummyTaskExecutor");
        this.setTaskSelectionExecutorPluginClass(
                "org.onap.policy.apex.services.onappf.parameters.dummyclasses.DummyTaskSelectExecutor");
        this.setStateFinalizerExecutorPluginClass(
                "org.onap.policy.apex.services.onappf.parameters.dummyclasses.DummyStateFinalizerExecutor");
    }
}
