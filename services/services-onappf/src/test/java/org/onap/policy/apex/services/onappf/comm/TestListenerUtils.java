...
public class TestListenerUtils {
    ...
    public static ToscaPolicy createToscaPolicy(String policyName, String policyVersion, String policyFilePath)
        ...
        try {
            String policyModelString = TextFileUtils.getTextFileAsString(policyFilePath);
            Object properties = new StandardCoder().decode(policyModelString, JsonObject.class);
