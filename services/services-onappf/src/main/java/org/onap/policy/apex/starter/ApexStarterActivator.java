...
public class ApexStarterActivator {
    ...
    public ApexStarterActivator(final ApexStarterParameterGroup apexStarterParameterGroup,
        ...
        // currently instanceId is just a random string
        // this could be fetched from the actual deployment
        ...
        this.manager = new ServiceManager()
                ...
                .addAction("register context map",
                        () -> Registry.register(ApexStarterConstants.REG_PDP_STATUS_OBJECT,
                                new PdpMessageHandler().createPdpStatusFromParameters(instanceId, apexStarterParameterGroup.getPdpStatusParameters())),
                ...
                .addAction("Communication handler",
                        () -> startCommunicationHandler(topicSinks, topicSources, apexStarterParameterGroup.getPdpStatusParameters()),
