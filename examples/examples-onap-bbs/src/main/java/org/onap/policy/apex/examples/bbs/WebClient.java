    ...
    public String httpsRequest(String requestUrl, String requestMethod,
        ...
        try {
            ...
            if ((username != null) && (pass != null)) {
                ...
                httpUrlConn.setRequestProperty("Authorization", basicAuth);
            } else {
                httpUrlConn.setRequestProperty("Authorization", "Basic QUFJOkFBSQ==");
            }
    ...
    public String httpRequest(String requestUrl, String requestMethod,
        ...
        try {
            ...
            if ((username != null) && (pass != null)) {
                ...
                String basicAuth = "Basic " + java.util.Base64.getEncoder().encodeToString(userCredentials.getBytes());
                httpUrlConn.setRequestProperty("Authorization", basicAuth);
                LOGGER.info("httpRequest basic auth " + basicAuth);
            } else {
                httpUrlConn.setRequestProperty("Authorization", "Basic QUFJOkFBSQ==");
            }
