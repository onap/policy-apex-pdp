...
public class OnapVcpeRunner {
    ...
    private OnapVcpeRunner() throws ApexException {
        ...
        final String[] cliArgs = new String[] {
            ...
            "-l",
            "src/test/resources/log/ONAPvCPEPolicyModel.log",
            "-o",
            "src/test/resources/model/ONAPvCPEPolicyModel.json"
        };
        // @formatter:on
        ...
        final String[] apexArgs = {
            "src/main/resources/examples/config/ONAPvCPE/ApexConfig.json"
        };
        // @formatter:on
