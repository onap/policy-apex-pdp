...
public class ApexDeploymentRestMain {
    ...
    private static final PrintStream outputLogger =
        IoBuilder.forLogger(LogManager.getLogger(ApexDeploymentRestMain.class)).buildPrintStream();
    ...
    public static void main(final String[] args) {
        try {
            final ApexDeploymentRestMain restMain = new ApexDeploymentRestMain(args, outputLogger);
            restMain.init();
        } catch (final Exception e) {
