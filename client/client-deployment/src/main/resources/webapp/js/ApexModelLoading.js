	...
	$(submitButton)
			.click(
					function() {
						...
						var ignoreConflicts = $(ignoreConflictsCheckbox).is(
								":checked");
						var forceUpdate = $(forceUpdateCheckbox).is(":checked");
						ajax_upload(restRootURL + "modelupload/",
								uploadCallback, this.engineURL.hostname,
								this.engineURL.port, file, ignoreConflicts,
								forceUpdate);
					}.bind(this));
