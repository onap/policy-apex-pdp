...
public class ModelHandler implements RestCommandHandler {
    ...
    private ApexApiResult loadFromString(final RestSession session, final String jsonString) {
        ...
        LOGGER.exit("Model/Load" + (result != null && result.isOk() ? OK : NOT_OK)); // NOSONAR
        return result;
    }
    ...
    private ApexApiResult createModel(final RestSession session, final String jsonString) {
        ...
        // disabling sonar because this code checks if result is not null
        LOGGER.exit("Model/Create" + (result != null && result.isOk() ? OK : NOT_OK)); // NOSONAR
        return result;
    }
    ...
    private ApexApiResult updateModel(final RestSession session, final String jsonString) {
        ...
        // disabling sonar because this code checks if result is not null
        LOGGER.exit("Model/Update" + (result != null && result.isOk() ? OK : NOT_OK)); // NOSONAR
        return result;
    }
    ...
    private ApexApiResult listModel(final RestSession session) {
        ...
        // disabling sonar because this code checks if result is not null
        LOGGER.exit("Model/Get" + (result != null && result.isOk() ? OK : NOT_OK)); // NOSONAR
        return result;
    }
    ...
    private ApexApiResult deleteModel(final RestSession session) {
        ...
        // disabling sonar because this code checks if result is not null
        LOGGER.exit("Model/Delete" + (result != null && result.isOk() ? OK : NOT_OK)); // NOSONAR
        return result;
    }
