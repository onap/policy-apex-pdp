...
package org.onap.policy.apex.integration.context.test.distribution;
...
import static org.onap.policy.apex.integration.context.test.factory.TestContextAlbumFactory.createPolicyContextModel;
import static org.onap.policy.apex.integration.context.test.utils.Constants.BYTE_VAL;
import static org.onap.policy.apex.integration.context.test.utils.Constants.EXCEPTION_MESSAGE;
import static org.onap.policy.apex.integration.context.test.utils.Constants.EXTERNAL_CONTEXT;
import static org.onap.policy.apex.integration.context.test.utils.Constants.EXTERNAL_CONTEXT_ALBUM;
import static org.onap.policy.apex.integration.context.test.utils.Constants.FLOAT_VAL;
import static org.onap.policy.apex.integration.context.test.utils.Constants.GLOBAL_CONTEXT_ALBUM;
import static org.onap.policy.apex.integration.context.test.utils.Constants.GLOBAL_CONTEXT_KEY;
import static org.onap.policy.apex.integration.context.test.utils.Constants.INT_VAL;
import static org.onap.policy.apex.integration.context.test.utils.Constants.INT_VAL_2;
import static org.onap.policy.apex.integration.context.test.utils.Constants.INT_VAL_3;
import static org.onap.policy.apex.integration.context.test.utils.Constants.LONG_VAL;
import static org.onap.policy.apex.integration.context.test.utils.Constants.PI_VAL;
import static org.onap.policy.apex.integration.context.test.utils.Constants.POLICY_CONTEXT_ALBUM;
import static org.onap.policy.apex.integration.context.test.utils.Constants.STRING_EXT_VAL;
import static org.onap.policy.apex.integration.context.test.utils.Constants.STRING_GLOBAL_VAL;
import static org.onap.policy.apex.integration.context.test.utils.Constants.STRING_VAL;
import static org.onap.policy.apex.integration.context.test.utils.Constants.TEST_POLICY_CONTEXT_ITEM;
import static org.onap.policy.apex.integration.context.test.utils.Constants.TIME_ZONE;
import static org.onap.policy.apex.integration.context.test.utils.Constants.VERSION;
...
import org.onap.policy.apex.integration.context.test.concepts.TestContextBooleanItem;
import org.onap.policy.apex.integration.context.test.concepts.TestContextByteItem;
import org.onap.policy.apex.integration.context.test.concepts.TestContextDateItem;
import org.onap.policy.apex.integration.context.test.concepts.TestContextDateLocaleItem;
import org.onap.policy.apex.integration.context.test.concepts.TestContextDateTzItem;
import org.onap.policy.apex.integration.context.test.concepts.TestContextDoubleItem;
import org.onap.policy.apex.integration.context.test.concepts.TestContextFloatItem;
import org.onap.policy.apex.integration.context.test.concepts.TestContextIntItem;
import org.onap.policy.apex.integration.context.test.concepts.TestContextLongItem;
import org.onap.policy.apex.integration.context.test.concepts.TestContextLongObjectItem;
import org.onap.policy.apex.integration.context.test.concepts.TestContextStringItem;
import org.onap.policy.apex.integration.context.test.concepts.TestContextTreeMapItem;
import org.onap.policy.apex.integration.context.test.concepts.TestContextTreeSetItem;
import org.onap.policy.apex.integration.context.test.concepts.TestExternalContextItem;
import org.onap.policy.apex.integration.context.test.concepts.TestGlobalContextItem;
import org.onap.policy.apex.integration.context.test.concepts.TestPolicyContextItem;
import org.onap.policy.apex.integration.context.test.factory.TestContextAlbumFactory;
