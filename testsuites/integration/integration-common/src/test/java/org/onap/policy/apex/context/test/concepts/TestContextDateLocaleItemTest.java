...
class TestContextDateLocaleItemTest {
    ...
    void contextDateLocaleItemTest() {
        ...
        Assertions.assertNotEquals(new TestContextDateLocaleItem(tcdi, tzValue, false, 0, "English", "England"),
                new TestContextDateLocaleItem());
        Assertions.assertNotEquals(tcdli, new TestContextDateLocaleItem(tcdli));
        ...
        Assertions.assertNotEquals(tcdli, nullTcdli);
    }
}
