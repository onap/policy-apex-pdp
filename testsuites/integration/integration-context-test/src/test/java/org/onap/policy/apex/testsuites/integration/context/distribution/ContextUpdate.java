...
public class ContextUpdate {
    ...
    public void testContextUpdate() throws ApexException {
        ...
        assertThatThrownBy(() -> longContextAlbum.put(NUMBER_ZERO, ZERO))
            .hasMessageContaining("Failed to set context value for key \"0\" in album \"LongContextAlbum:0.0.1\":"
        ...
        assertThatThrownBy(() -> longContextAlbum.put(NUMBER_ZERO, null))
            .hasMessageContaining("album \"LongContextAlbum:0.0.1\" null values are illegal on key \"0\" for put()");
        assertThatThrownBy(() -> longContextAlbum.put(null, null))
            .hasMessageContaining("album \"LongContextAlbum:0.0.1\" null keys are illegal on keys for put()");
